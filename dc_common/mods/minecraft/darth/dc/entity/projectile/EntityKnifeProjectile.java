package mods.minecraft.darth.dc.entity.projectile;
...
//NOTE FROM ROCK:: Copied a lot of stuff over to be able to pick up a knife from the projectile instead of an arrow, what a pain...
	public class EntityKnifeProjectile extends EntityArrow
	{
	    private int xTile = -1;
	    private int yTile = -1;
	    private int zTile = -1;
